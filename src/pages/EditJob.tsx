...
import { ArrowLeft, Network, Clock, Shield, AlertTriangle, Save } from 'lucide-react';
...
function EditJob() {
  ...
  const fetchJobData = async () => {
    try {
      ...
      setFormData({
        name: job.name,
        network_interface: job.network_interface,
        subnet: job.subnet,
        execution_time: job.execution_time,
        schedule: job.schedule,
        notifications_enabled: job.notifications_enabled,
        notify_new_macs: job.notify_new_macs,
        notify_unauthorized_macs: job.notify_unauthorized_macs,
        notify_ip_changes: job.notify_ip_changes,
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-dark-400">Modify job configuration and settings</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex items-center justify-end space-x-4">
          ...
          <button
            ...
            className="flex items-center space-x-2 px-6 py-3 bg-neon-cyan text-dark-950 rounded-lg hover:bg-neon-cyan/90 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
